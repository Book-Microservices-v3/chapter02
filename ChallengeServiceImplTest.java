...
public class ChallengeServiceImplTest {
  ...
  public void setUp() {
   ...
   public void checkCorrectAttemptTest() {
    ...
    ChallengeAttempt attempt = new ChallengeAttempt(null, savedUser, 50, 60, 3000, true);
    ChallengeAttempt storedAttempt = new ChallengeAttempt(attemptId, savedUser, 50, 60, 3000, true);
    ChallengeSolvedEvent event = new ChallengeSolvedEvent(attemptId, true, attempt.getFactorA(), attempt.getFactorB(), userId, attempt.getUser().getAlias());
    ...
    // when
    ChallengeAttempt resultAttempt = challengeServiceImpl.checkAttempt(attemptDTO);
